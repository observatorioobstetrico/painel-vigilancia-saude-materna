...
data.frame(grupo_robson, porc_nascidos, porc_cesareas, referencia_porc_cesareas) |>
  dplyr::mutate(
    porc_nascidos = ifelse(grepl("NA", porc_nascidos), "---", porc_nascidos),
    porc_cesareas = ifelse(grepl("NA", porc_cesareas), "---", porc_cesareas)
  ) |>
  reactable::reactable(
    defaultColDef = reactable::colDef(
      footerStyle = list(fontWeight = "bold"),
...
data.frame(
  ...
  dplyr::mutate(
    valor_observado = ifelse(valor_observado == "%" | valor_observado == " km", "---", valor_observado),
    valor_de_referencia = ifelse(grepl("NA|NaN", valor_de_referencia), "---", valor_de_referencia)
  ) |>
  reactable::reactable(
    defaultColDef = reactable::colDef(
