...
mod_bloco_2_server <- function(id, filtros, titulo_localidade_aux){
  moduleServer( id, function(input, output, session){
    ...
    bloco2_calcs <- data.frame(
      ...
      porc_menor20 = c("round(sum(nvm_menor_que_20) / sum(pop_feminina_10_a_19[ano <= 2021]) * 1000, 1)", "20"),
    ...
    output$caixa_b2_i3 <- renderUI({
      cria_caixa_server(
        ...
        tem_meta = FALSE,
        valor_de_referencia = data_resumo_brasil()$geral_tx_abortos_mil_mulheres_valor_medio,
        tipo = "taxa",
        invertido = FALSE,
        tamanho_caixa = "300px",
        fonte_titulo = "15px",
    ...
    output$caixa_b2_i4 <- renderUI({
      cria_caixa_server(
        ...
        tem_meta = FALSE,
        valor_de_referencia = data_resumo_brasil()$geral_tx_abortos_cem_nascidos_vivos_valor_medio,
        tipo = "taxa",
        invertido = FALSE,
        tamanho_caixa = "300px",
        fonte_titulo = "15px",
